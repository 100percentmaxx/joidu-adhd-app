                  ...
                  >
                    <div
                      style={{
                        ...
                        height: '20px',
                        borderRadius: '50%',
                        backgroundColor: selectedCategories.includes(category.id) ? '#a8e2bb' : 'var(--card-background)',
              ...
              <label style={{
                ...
                <div
                  style={{
                    ...
                    height: '20px',
                    borderRadius: '50%',
                    backgroundColor: includeDeviceInfo ? '#a8e2bb' : 'var(--card-background)',
                ...
                >
                  <div
                    style={{
                      ...
                      height: '20px',
                      borderRadius: '50%',
                      backgroundColor: severity === option.id ? '#a8e2bb' : 'var(--card-background)',
