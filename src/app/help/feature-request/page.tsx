                ...
                >
                  <div
                    style={{
                      ...
                      height: '20px',
                      borderRadius: '50%',
                      backgroundColor: impact === option.id ? '#a8e2bb' : '#ffffff',
                      border: impact === option.id ? 'none' : '2px solid #e2e2e2',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      marginRight: '8px',
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: '20px',
                        borderRadius: '50%',
                        backgroundColor: userTypes.includes(type.id) ? '#a8e2bb' : '#ffffff',
                        border: userTypes.includes(type.id) ? 'none' : '2px solid #e2e2e2',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        marginRight: '12px',
              ...
              <label style={{
                ...
                <div
                  style={{
                    ...
                    height: '20px',
                    borderRadius: '50%',
                    backgroundColor: emailUpdates ? '#a8e2bb' : '#ffffff',
                    border: emailUpdates ? 'none' : '2px solid #e2e2e2',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    marginRight: '8px',
