...
import ExportInfoBox from '../data-export/components/ExportInfoBox'
import ExportCategory from '../data-export/components/ExportCategory'
import FormatSelector from '../data-export/components/FormatSelector'
import ExportSummary from '../data-export/components/ExportSummary'
...
export default function SignOutDataExportPage() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      // Show success message after delay, then navigate back to sign out flow
      setTimeout(() => {
        alert('Export sent to your email address!')
        setIsExporting(false)
        
        // Navigate back to settings page and trigger sign out modal in initial state
        // User will see the complete sign out page with all content
        router.push('/settings?signout=complete')
      }, 2000)
    } catch (error) {
