...
interface ResponseStyleSelectorProps {
  ...
  onChange: (value: 'concise' | 'balanced' | 'detailed') => void
}

export default function ResponseStyleSelector({ value, onChange }: ResponseStyleSelectorProps) {
  const options = [
    { 
  ...
  return (
    <div style={{
      ...
      <p style={{
        ...
        How would you like Kai to communicate?
      </p>
